...
class SuggestionEvaluator:
    ...
    def evaluate(self, suggestion, soul_state, word_ledger, dark_drives):
        ...
        suggestion_coherence = round(
            min(1.0, 0.4 + soul_signal * 0.3 + (valence * 0.2) - drive_signal * 0.1),
            3
        )
        ...
        # ── Verdict logic ──────────────────────────────────────────────────
        if suggestion_coherence >= 0.65 and resistance < 0.5:
        ...
        elif suggestion_coherence >= 0.55 and resistance >= 0.82:
